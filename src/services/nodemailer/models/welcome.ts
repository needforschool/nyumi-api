const HTML_WELCOME = (confirmationUrl: string): string => `
<!doctype html>
<html>
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                  ...
                  <tr>
                    <td style="font-family: 'Poppins', sans-serif; font-size: 14px; vertical-align: top;" valign="top" color: "white";>
                      ...
                      <p
                        style="font-family: 'Poppins', sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                        Thank you for signing up and welcome to Expat's Facilities !<br />Please click on the button below to verify your email address:</p>
                                  ...
                                  <tr>
                                    <td
                                      ...
                                      valign="top" align="center" bgcolor="#3498db"> <a href="${confirmationUrl}""
                                        target="_blank"
                                        style="border: solid 1px #3498db; border-radius: 5px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-decoration: none; background-color: rgb(255,66,0); border-color: rgb(255,66,0); color: #ffffff;">Verify your email</a> </td>
                                  </tr>
                                </tbody>
                              </table>
                            </td>
